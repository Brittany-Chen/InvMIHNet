        ...
        for _, train_data in enumerate(train_loader):
            ...
            if current_step % opt['train']['val_freq'] == 0 and rank <= 0:
                ...
                for val_data in val_loader:
                    ...
                    cover_path = img_dir + "\\" + "cover"
                    secret_path = img_dir + "\\" + "secret"
                    secret_recover_path = img_dir + "\\" + "secret_recover"
                    steg_path = img_dir + "\\" + "steg"
                    ...
                    for i in range(int(secret.shape[0])):
                        ...
                        save_secret_recover_path = osp.join(secret_recover_path,
                                                            str(count) + '_' + str(i) + '_secret_recover.png')
